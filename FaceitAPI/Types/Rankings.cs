...
namespace FaceitAPI.Types
{
    public class Rankings : ApiBase, IRankings
    {
        ...
        {
            return Get<RankingPaging<SimpleGamePlayer>>(
                $"https://open.faceit.com/data/v4/rankings/games/{game_id}/regions/{region}/players/{player_id}?country={country}&limit={limit}");
        }
        ...
        {
            return Get<Paging<SimpleGamePlayer>>(
                $"https://open.faceit.com/data/v4/rankings/games/{game_id}/regions/{region}?country={country}&offset={offset}&limit={limit}");
        }
    }
}